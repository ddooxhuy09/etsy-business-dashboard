...
# Product Catalog: /api/static/product-catalog
app.include_router(product_catalog_router)
app.include_router(product_catalog_import_router)

# Bank Account: /api/static/bank-transactions
app.include_router(bank_account_router)
app.include_router(bank_account_import_router)
