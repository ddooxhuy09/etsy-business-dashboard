"""
FastAPI routes for chart data.
Charts use shared.query_utils via features.charts.calculations.
"""
import re
import calendar
import logging
...
from features.charts.calculations.get_total_revenue import get_total_revenue

logger = logging.getLogger(__name__)
from features.charts.calculations.get_total_orders import get_total_orders
from features.charts.calculations.get_total_customers import get_total_customers
from features.charts.calculations.get_average_order_value import get_average_order_value
from features.charts.calculations.get_revenue_by_month import get_revenue_by_month
from features.charts.calculations.get_profit_by_month import get_profit_by_month
from features.charts.calculations.get_new_vs_returning_customer_sales import get_new_vs_returning_customer_sales
from features.charts.calculations.get_new_customers_over_time import get_new_customers_over_time
from features.charts.calculations.get_customers_by_location import get_customers_by_location
from features.charts.calculations.get_customer_retention_rate import get_customer_retention_rate
from features.charts.calculations.get_total_sales_by_product import get_total_sales_by_product
from features.charts.calculations.get_customer_acquisition_cost import get_customer_acquisition_cost
from features.charts.calculations.get_customer_lifetime_value import get_customer_lifetime_value
from features.charts.calculations.get_cac_clv_ratio_over_time import get_cac_clv_ratio_over_time
from features.charts.calculations.get_total_orders_by_month import get_total_orders_by_month
from features.charts.calculations.get_average_order_value_over_time import get_average_order_value_over_time
from features.charts.calculations.get_revenue_comparison_by_month import (
...
def _safe_chart_call(chart_func, *args, **kwargs):
    """Wrapper to call chart function safely: returns empty DataFrame on error."""
    try:
